	...
	<?php if ( get_header_image() && $himage == '' ) : ?>
		...
		<?php else : ?>
			...
			<?php if ( get_theme_mod('mobile_header') ) : ?>
				<img class="header-image" src="<?php echo esc_url( get_theme_mod('mobile_header') ); ?>" width="auto" height="auto" />
			<?php else : ?>
				<img class="header-image" src="<?php echo esc_url(get_header_image()); ?>" width="auto" height="auto" />
			<?php endif; ?>
		<?php endif; ?>
